...
{
public:
	TDelegate<void(struct FGuid& PinId, TSet<class FString>& PinnedObjectIds)> Delegate;                                          // 0x0000(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
