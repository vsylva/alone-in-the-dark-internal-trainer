...
static_assert(alignof(BinkMediaPlayer_IsSeeking) == 0x000001, "Wrong alignment on BinkMediaPlayer_IsSeeking");
static_assert(sizeof(BinkMediaPlayer_IsSeeking) == 0x000001, "Wrong size on BinkMediaPlayer_IsSeeking");
static_assert(offsetof(BinkMediaPlayer_IsSeeking, ReturnValue) == 0x000000, "Member 'BinkMediaPlayer_IsSeeking::ReturnValue' has a wrong offset!");
