...
{
public:
	struct FGuid                                  PinId;                                             // 0x0238(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bVisibilityOverride;                               // 0x0248(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AMagicLeapARPinInfoActorBase) == 0x000250, "Wrong size on AMagicLeapARPinInfoActorBase");
static_assert(offsetof(AMagicLeapARPinInfoActorBase, PinId) == 0x000238, "Member 'AMagicLeapARPinInfoActorBase::PinId' has a wrong offset!");
static_assert(offsetof(AMagicLeapARPinInfoActorBase, bVisibilityOverride) == 0x000248, "Member 'AMagicLeapARPinInfoActorBase::bVisibilityOverride' has a wrong offset!");
...
{
public:
	bool                                          bInfoActorsVisibilityOverride;                     // 0x0238(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_239[0x7];                                      // 0x0239(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FGuid, class AMagicLeapARPinInfoActorBase*> AllInfoActors;                                     // 0x0240(0x0050)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_290[0x8];                                      // 0x0290(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class AMagicLeapARPinInfoActorBase> ClassToSpawn;                                      // 0x0298(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AMagicLeapARPinRenderer) == 0x0002A0, "Wrong size on AMagicLeapARPinRenderer");
static_assert(offsetof(AMagicLeapARPinRenderer, bInfoActorsVisibilityOverride) == 0x000238, "Member 'AMagicLeapARPinRenderer::bInfoActorsVisibilityOverride' has a wrong offset!");
static_assert(offsetof(AMagicLeapARPinRenderer, AllInfoActors) == 0x000240, "Member 'AMagicLeapARPinRenderer::AllInfoActors' has a wrong offset!");
static_assert(offsetof(AMagicLeapARPinRenderer, ClassToSpawn) == 0x000298, "Member 'AMagicLeapARPinRenderer::ClassToSpawn' has a wrong offset!");
