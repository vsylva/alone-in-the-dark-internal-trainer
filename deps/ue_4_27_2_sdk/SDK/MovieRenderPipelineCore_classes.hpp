...
static_assert(sizeof(AMoviePipelineGameMode) == 0x0002E0, "Wrong size on AMoviePipelineGameMode");
...
static_assert(sizeof(UMoviePipelineGameOverrideSetting) == 0x000120, "Wrong size on UMoviePipelineGameOverrideSetting");
