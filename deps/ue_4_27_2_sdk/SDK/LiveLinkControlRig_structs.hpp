...
static_assert(sizeof(FRigUnit_LiveLinkEvaluteFrameTransform) == 0x000090, "Wrong size on FRigUnit_LiveLinkEvaluteFrameTransform");
...
static_assert(offsetof(FRigUnit_LiveLinkEvaluteFrameTransform, Transform) == 0x000060, "Member 'FRigUnit_LiveLinkEvaluteFrameTransform::Transform' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_LiveLinkGetTransformByName) == 0x000060, "Wrong size on FRigUnit_LiveLinkGetTransformByName");
...
static_assert(sizeof(FRigUnit_LiveLinkEvaluteFrameAnimation) == 0x000080, "Wrong size on FRigUnit_LiveLinkEvaluteFrameAnimation");
...
static_assert(offsetof(FRigUnit_LiveLinkEvaluteFrameAnimation, SubjectFrame) == 0x000060, "Member 'FRigUnit_LiveLinkEvaluteFrameAnimation::SubjectFrame' has a wrong offset!");
