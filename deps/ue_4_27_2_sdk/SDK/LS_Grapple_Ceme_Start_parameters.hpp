...
// 0x0008 (0x0008 - 0x0000)
struct SequenceDirector_C_SendEndStartEvent final
{
public:
	class ABP_CemeteryCreature_A_C*               BP_CemeteryCreature_A;                             // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(SequenceDirector_C_SendEndStartEvent) == 0x000008, "Wrong alignment on SequenceDirector_C_SendEndStartEvent");
static_assert(sizeof(SequenceDirector_C_SendEndStartEvent) == 0x000008, "Wrong size on SequenceDirector_C_SendEndStartEvent");
static_assert(offsetof(SequenceDirector_C_SendEndStartEvent, BP_CemeteryCreature_A) == 0x000000, "Member 'SequenceDirector_C_SendEndStartEvent::BP_CemeteryCreature_A' has a wrong offset!");
...
public:
	...
	class ACineCameraActor*                       K2Node_CustomEvent_Cine_Camera_Actor;              // 0x0010(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(SequenceDirector_C_ExecuteUbergraph_SequenceDirector, K2Node_CustomEvent_Cine_Camera_Actor) == 0x000010, "Member 'SequenceDirector_C_ExecuteUbergraph_SequenceDirector::K2Node_CustomEvent_Cine_Camera_Actor' has a wrong offset!");
