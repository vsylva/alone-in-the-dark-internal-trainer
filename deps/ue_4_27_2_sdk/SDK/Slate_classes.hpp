...
static_assert(sizeof(UEditableTextBoxWidgetStyle) == 0x000828, "Wrong size on UEditableTextBoxWidgetStyle");
...
static_assert(sizeof(UEditableTextWidgetStyle) == 0x000250, "Wrong size on UEditableTextWidgetStyle");
...
static_assert(sizeof(UScrollBarWidgetStyle) == 0x000500, "Wrong size on UScrollBarWidgetStyle");
