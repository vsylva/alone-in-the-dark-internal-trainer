...
{
public:
	class UNiagaraComponent*                      NiagaraComponent;                                  // 0x0238(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bDestroyOnSystemFinish : 1;                        // 0x0240(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
static_assert(offsetof(ANiagaraActor, NiagaraComponent) == 0x000238, "Member 'ANiagaraActor::NiagaraComponent' has a wrong offset!");
...
{
public:
	class UNiagaraSystem*                         Asset;                                             // 0x0460(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	ENiagaraTickBehavior                          TickBehavior;                                      // 0x0468(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_469[0x3];                                      // 0x0469(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         RandomSeedOffset;                                  // 0x046C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FNiagaraUserRedirectionParameterStore  OverrideParameters;                                // 0x0470(0x00C8)(NativeAccessSpecifierPrivate)
	uint8                                         bForceSolo : 1;                                    // 0x0538(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bEnableGpuComputeDebug : 1;                        // 0x0538(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         BitPad_538_2 : 6;                                  // 0x0538(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
	uint8                                         Pad_539[0x2F];                                     // 0x0539(0x002F)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bAutoDestroy : 1;                                  // 0x0568(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bRenderingEnabled : 1;                             // 0x0568(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bAutoManageAttachment : 1;                         // 0x0568(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAutoAttachWeldSimulatedBodies : 1;                // 0x0568(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_569[0x3];                                      // 0x0569(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MaxTimeBeforeForceUpdateTransform;                 // 0x056C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FNiagaraMaterialOverride>       EmitterMaterials;                                  // 0x0570(0x0010)(ZeroConstructor, Transient, DuplicateTransient, NativeAccessSpecifierPublic)
	uint8                                         Pad_580[0x8];                                      // 0x0580(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnSystemFinished;                                  // 0x0588(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_5AB[0x5D];                                     // 0x05AB(0x005D)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UNiagaraComponent, Asset) == 0x000460, "Member 'UNiagaraComponent::Asset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, TickBehavior) == 0x000468, "Member 'UNiagaraComponent::TickBehavior' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, RandomSeedOffset) == 0x00046C, "Member 'UNiagaraComponent::RandomSeedOffset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OverrideParameters) == 0x000470, "Member 'UNiagaraComponent::OverrideParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, MaxTimeBeforeForceUpdateTransform) == 0x00056C, "Member 'UNiagaraComponent::MaxTimeBeforeForceUpdateTransform' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, EmitterMaterials) == 0x000570, "Member 'UNiagaraComponent::EmitterMaterials' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OnSystemFinished) == 0x000588, "Member 'UNiagaraComponent::OnSystemFinished' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachParent) == 0x000598, "Member 'UNiagaraComponent::AutoAttachParent' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachSocketName) == 0x0005A0, "Member 'UNiagaraComponent::AutoAttachSocketName' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachLocationRule) == 0x0005A8, "Member 'UNiagaraComponent::AutoAttachLocationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachRotationRule) == 0x0005A9, "Member 'UNiagaraComponent::AutoAttachRotationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachScaleRule) == 0x0005AA, "Member 'UNiagaraComponent::AutoAttachScaleRule' has a wrong offset!");
...
{
public:
	class UNiagaraBaselineController*             Controller;                                        // 0x0238(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTextRenderComponent*                   Label;                                             // 0x0240(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ANiagaraPerfBaselineActor) == 0x000248, "Wrong size on ANiagaraPerfBaselineActor");
static_assert(offsetof(ANiagaraPerfBaselineActor, Controller) == 0x000238, "Member 'ANiagaraPerfBaselineActor::Controller' has a wrong offset!");
static_assert(offsetof(ANiagaraPerfBaselineActor, Label) == 0x000240, "Member 'ANiagaraPerfBaselineActor::Label' has a wrong offset!");
...
static_assert(sizeof(ANiagaraPreviewBase) == 0x000238, "Wrong size on ANiagaraPreviewBase");
...
{
public:
	class UNiagaraSystem*                         System;                                            // 0x0238(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraPreviewGridResetMode                  ResetMode;                                         // 0x0240(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_241[0x7];                                      // 0x0241(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UNiagaraPreviewAxis*                    PreviewAxisX;                                      // 0x0248(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNiagaraPreviewAxis*                    PreviewAxisY;                                      // 0x0250(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class ANiagaraPreviewBase>        PreviewClass;                                      // 0x0258(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SpacingX;                                          // 0x0260(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SpacingY;                                          // 0x0264(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumX;                                              // 0x0268(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         NumY;                                              // 0x026C(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UChildActorComponent*>           PreviewComponents;                                 // 0x0270(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(ANiagaraPreviewGrid) == 0x000288, "Wrong size on ANiagaraPreviewGrid");
static_assert(offsetof(ANiagaraPreviewGrid, System) == 0x000238, "Member 'ANiagaraPreviewGrid::System' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, ResetMode) == 0x000240, "Member 'ANiagaraPreviewGrid::ResetMode' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewAxisX) == 0x000248, "Member 'ANiagaraPreviewGrid::PreviewAxisX' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewAxisY) == 0x000250, "Member 'ANiagaraPreviewGrid::PreviewAxisY' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewClass) == 0x000258, "Member 'ANiagaraPreviewGrid::PreviewClass' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, SpacingX) == 0x000260, "Member 'ANiagaraPreviewGrid::SpacingX' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, SpacingY) == 0x000264, "Member 'ANiagaraPreviewGrid::SpacingY' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, NumX) == 0x000268, "Member 'ANiagaraPreviewGrid::NumX' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, NumY) == 0x00026C, "Member 'ANiagaraPreviewGrid::NumY' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewComponents) == 0x000270, "Member 'ANiagaraPreviewGrid::PreviewComponents' has a wrong offset!");
