...
// 0x02E0 (0x0CF0 - 0x0A10)
struct FControlRigSequencerAnimInstanceProxy final : public FAnimSequencerInstanceProxy
{
public:
	uint8                                         Pad_A10[0x2E0];                                    // 0x0A10(0x02E0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(FControlRigSequencerAnimInstanceProxy) == 0x000CF0, "Wrong size on FControlRigSequencerAnimInstanceProxy");
...
public:
	...
	bool                                          bHit;                                              // 0x0029(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FRigUnit_SphereTraceWorld, bTraceComplex) == 0x000028, "Member 'FRigUnit_SphereTraceWorld::bTraceComplex' has a wrong offset!");
static_assert(offsetof(FRigUnit_SphereTraceWorld, bHit) == 0x000029, "Member 'FRigUnit_SphereTraceWorld::bHit' has a wrong offset!");
