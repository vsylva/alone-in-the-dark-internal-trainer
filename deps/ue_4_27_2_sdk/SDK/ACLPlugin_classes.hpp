...
public:
	...
	uint8                                         Pad_48[0xD0];                                      // 0x0048(0x00D0)(Fixing Size After Last Property [ Dumper-7 ])
	uint32                                        MaxStreamRequestSizeKB;                            // 0x0118(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EACLVisualFidelity                            DefaultVisualFidelity;                             // 0x011C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UAnimationCompressionLibraryDatabase) == 0x000120, "Wrong size on UAnimationCompressionLibraryDatabase");
...
static_assert(offsetof(UAnimationCompressionLibraryDatabase, MaxStreamRequestSizeKB) == 0x000118, "Member 'UAnimationCompressionLibraryDatabase::MaxStreamRequestSizeKB' has a wrong offset!");
static_assert(offsetof(UAnimationCompressionLibraryDatabase, DefaultVisualFidelity) == 0x00011C, "Member 'UAnimationCompressionLibraryDatabase::DefaultVisualFidelity' has a wrong offset!");
