...
{
public:
	FMulticastInlineDelegateProperty_             OnLiveLinkUpdated;                                 // 0x00B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ULiveLinkComponent) == 0x0000D8, "Wrong size on ULiveLinkComponent");
static_assert(offsetof(ULiveLinkComponent, OnLiveLinkUpdated) == 0x0000B8, "Member 'ULiveLinkComponent::OnLiveLinkUpdated' has a wrong offset!");
...
static_assert(offsetof(ULiveLinkDrivenComponent, SubjectName) == 0x0000B8, "Member 'ULiveLinkDrivenComponent::SubjectName' has a wrong offset!");
static_assert(offsetof(ULiveLinkDrivenComponent, ActorTransformBone) == 0x0000C0, "Member 'ULiveLinkDrivenComponent::ActorTransformBone' has a wrong offset!");
static_assert(offsetof(ULiveLinkDrivenComponent, bModifyActorTransform) == 0x0000C8, "Member 'ULiveLinkDrivenComponent::bModifyActorTransform' has a wrong offset!");
static_assert(offsetof(ULiveLinkDrivenComponent, bSetRelativeLocation) == 0x0000C9, "Member 'ULiveLinkDrivenComponent::bSetRelativeLocation' has a wrong offset!");
...
static_assert(sizeof(ULiveLinkInstance) == 0x0002D0, "Wrong size on ULiveLinkInstance");
static_assert(offsetof(ULiveLinkInstance, CurrentRetargetAsset) == 0x0002C8, "Member 'ULiveLinkInstance::CurrentRetargetAsset' has a wrong offset!");
