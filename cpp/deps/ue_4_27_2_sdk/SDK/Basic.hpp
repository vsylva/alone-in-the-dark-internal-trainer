...
namespace Offsets
{
	constexpr int32 GObjects          = 0x05F56520;
	constexpr int32 AppendString      = 0x01A9CF30;
	constexpr int32 GNames            = 0x05F1A1C0;
	constexpr int32 GWorld            = 0x0609AF80;
	constexpr int32 ProcessEvent      = 0x01C91220;
