...
static_assert(sizeof(FHoudiniOutputObject) == 0x0000E8, "Wrong size on FHoudiniOutputObject");
...
static_assert(offsetof(FHoudiniOutputObject, BakeName) == 0x000028, "Member 'FHoudiniOutputObject::BakeName' has a wrong offset!");
static_assert(offsetof(FHoudiniOutputObject, CurveOutputProperty) == 0x000038, "Member 'FHoudiniOutputObject::CurveOutputProperty' has a wrong offset!");
static_assert(offsetof(FHoudiniOutputObject, CachedAttributes) == 0x000048, "Member 'FHoudiniOutputObject::CachedAttributes' has a wrong offset!");
static_assert(offsetof(FHoudiniOutputObject, CachedTokens) == 0x000098, "Member 'FHoudiniOutputObject::CachedTokens' has a wrong offset!");
...
static_assert(sizeof(FHoudiniAssetBlueprintOutput) == 0x0000F0, "Wrong size on FHoudiniAssetBlueprintOutput");
...
public:
	...
	int32                                         VolumeTileIndex;                                   // 0x00B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_C4[0x14C];                                     // 0x00C4(0x014C)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(FHoudiniGeoPartObject) == 0x000220, "Wrong size on FHoudiniGeoPartObject");
...
static_assert(offsetof(FHoudiniGeoPartObject, VolumeTileIndex) == 0x0000B8, "Member 'FHoudiniGeoPartObject::VolumeTileIndex' has a wrong offset!");
static_assert(offsetof(FHoudiniGeoPartObject, bIsVisible) == 0x0000BC, "Member 'FHoudiniGeoPartObject::bIsVisible' has a wrong offset!");
static_assert(offsetof(FHoudiniGeoPartObject, bIsEditable) == 0x0000BD, "Member 'FHoudiniGeoPartObject::bIsEditable' has a wrong offset!");
static_assert(offsetof(FHoudiniGeoPartObject, bIsTemplated) == 0x0000BE, "Member 'FHoudiniGeoPartObject::bIsTemplated' has a wrong offset!");
static_assert(offsetof(FHoudiniGeoPartObject, bIsInstanced) == 0x0000BF, "Member 'FHoudiniGeoPartObject::bIsInstanced' has a wrong offset!");
static_assert(offsetof(FHoudiniGeoPartObject, bHasGeoChanged) == 0x0000C0, "Member 'FHoudiniGeoPartObject::bHasGeoChanged' has a wrong offset!");
static_assert(offsetof(FHoudiniGeoPartObject, bHasPartChanged) == 0x0000C1, "Member 'FHoudiniGeoPartObject::bHasPartChanged' has a wrong offset!");
static_assert(offsetof(FHoudiniGeoPartObject, bHasTransformChanged) == 0x0000C2, "Member 'FHoudiniGeoPartObject::bHasTransformChanged' has a wrong offset!");
static_assert(offsetof(FHoudiniGeoPartObject, bHasMaterialsChanged) == 0x0000C3, "Member 'FHoudiniGeoPartObject::bHasMaterialsChanged' has a wrong offset!");
static_assert(offsetof(FHoudiniGeoPartObject, AllMeshSockets) == 0x000210, "Member 'FHoudiniGeoPartObject::AllMeshSockets' has a wrong offset!");
...
static_assert(sizeof(FHoudiniBakedOutputObject) == 0x000068, "Wrong size on FHoudiniBakedOutputObject");
...
public:
	...
	bool                                          bChanged;                                          // 0x0070(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bStale;                                            // 0x0071(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FHoudiniInstancedOutput) == 0x000078, "Wrong size on FHoudiniInstancedOutput");
...
static_assert(offsetof(FHoudiniInstancedOutput, bChanged) == 0x000070, "Member 'FHoudiniInstancedOutput::bChanged' has a wrong offset!");
static_assert(offsetof(FHoudiniInstancedOutput, bStale) == 0x000071, "Member 'FHoudiniInstancedOutput::bStale' has a wrong offset!");
...
static_assert(sizeof(FTOPWorkResultObject) == 0x000068, "Wrong size on FTOPWorkResultObject");
...
static_assert(offsetof(FTOPWorkResultObject, OutputObjectsToDelete) == 0x000048, "Member 'FTOPWorkResultObject::OutputObjectsToDelete' has a wrong offset!");
static_assert(offsetof(FTOPWorkResultObject, OutputActorOwner) == 0x000058, "Member 'FTOPWorkResultObject::OutputActorOwner' has a wrong offset!");
...
public:
	...
	float                                         GeneratedLpvBiasMultiplier;                        // 0x0170(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FWalkableSlopeOverride                 GeneratedWalkableSlopeOverride;                    // 0x0174(0x0010)(Edit, IsPlainOldData, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	int32                                         GeneratedLightMapCoordinateIndex;                  // 0x0184(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bGeneratedUseMaximumStreamingTexelRatio : 1;       // 0x0188(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_189[0x3];                                      // 0x0189(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         GeneratedStreamingDistanceMultiplier;              // 0x018C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FHoudiniStaticMeshGenerationProperties, GeneratedLpvBiasMultiplier) == 0x000170, "Member 'FHoudiniStaticMeshGenerationProperties::GeneratedLpvBiasMultiplier' has a wrong offset!");
static_assert(offsetof(FHoudiniStaticMeshGenerationProperties, GeneratedWalkableSlopeOverride) == 0x000174, "Member 'FHoudiniStaticMeshGenerationProperties::GeneratedWalkableSlopeOverride' has a wrong offset!");
static_assert(offsetof(FHoudiniStaticMeshGenerationProperties, GeneratedLightMapCoordinateIndex) == 0x000184, "Member 'FHoudiniStaticMeshGenerationProperties::GeneratedLightMapCoordinateIndex' has a wrong offset!");
static_assert(offsetof(FHoudiniStaticMeshGenerationProperties, GeneratedStreamingDistanceMultiplier) == 0x00018C, "Member 'FHoudiniStaticMeshGenerationProperties::GeneratedStreamingDistanceMultiplier' has a wrong offset!");
