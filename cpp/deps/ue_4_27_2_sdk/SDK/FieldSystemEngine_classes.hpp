...
{
public:
	class UFieldSystemComponent*                  FieldSystemComponent;                              // 0x0238(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AFieldSystemActor) == 0x000240, "Wrong size on AFieldSystemActor");
static_assert(offsetof(AFieldSystemActor, FieldSystemComponent) == 0x000238, "Member 'AFieldSystemActor::FieldSystemComponent' has a wrong offset!");
...
{
public:
	class UFieldSystem*                           FieldSystem;                                       // 0x0460(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsWorldField;                                     // 0x0468(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsChaosField;                                     // 0x0469(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FFieldObjectCommands                   ConstructionCommands;                              // 0x0480(0x0030)(ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FFieldObjectCommands                   BufferCommands;                                    // 0x04B0(0x0030)(ContainsInstancedReference, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UFieldSystemComponent, FieldSystem) == 0x000460, "Member 'UFieldSystemComponent::FieldSystem' has a wrong offset!");
static_assert(offsetof(UFieldSystemComponent, bIsWorldField) == 0x000468, "Member 'UFieldSystemComponent::bIsWorldField' has a wrong offset!");
static_assert(offsetof(UFieldSystemComponent, bIsChaosField) == 0x000469, "Member 'UFieldSystemComponent::bIsChaosField' has a wrong offset!");
static_assert(offsetof(UFieldSystemComponent, SupportedSolvers) == 0x000470, "Member 'UFieldSystemComponent::SupportedSolvers' has a wrong offset!");
static_assert(offsetof(UFieldSystemComponent, ConstructionCommands) == 0x000480, "Member 'UFieldSystemComponent::ConstructionCommands' has a wrong offset!");
static_assert(offsetof(UFieldSystemComponent, BufferCommands) == 0x0004B0, "Member 'UFieldSystemComponent::BufferCommands' has a wrong offset!");
