...
static_assert(alignof(OpenCVLensCalibrator_CalculateLensParameters) == 0x000004, "Wrong alignment on OpenCVLensCalibrator_CalculateLensParameters");
static_assert(sizeof(OpenCVLensCalibrator_CalculateLensParameters) == 0x000048, "Wrong size on OpenCVLensCalibrator_CalculateLensParameters");
...
static_assert(offsetof(OpenCVLensCalibrator_CalculateLensParameters, MarginOfError) == 0x000034, "Member 'OpenCVLensCalibrator_CalculateLensParameters::MarginOfError' has a wrong offset!");
static_assert(offsetof(OpenCVLensCalibrator_CalculateLensParameters, CameraViewInfo) == 0x000038, "Member 'OpenCVLensCalibrator_CalculateLensParameters::CameraViewInfo' has a wrong offset!");
static_assert(offsetof(OpenCVLensCalibrator_CalculateLensParameters, ReturnValue) == 0x000044, "Member 'OpenCVLensCalibrator_CalculateLensParameters::ReturnValue' has a wrong offset!");
