...
// Function AIModule.AIController.IsBehaviourTreePaused
// 0x0001 (0x0001 - 0x0000)
struct AIController_IsBehaviourTreePaused final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AIController_IsBehaviourTreePaused) == 0x000001, "Wrong alignment on AIController_IsBehaviourTreePaused");
static_assert(sizeof(AIController_IsBehaviourTreePaused) == 0x000001, "Wrong size on AIController_IsBehaviourTreePaused");
static_assert(offsetof(AIController_IsBehaviourTreePaused, ReturnValue) == 0x000000, "Member 'AIController_IsBehaviourTreePaused::ReturnValue' has a wrong offset!");

// Function AIModule.AIController.IsBehaviourTreeRunning
// 0x0001 (0x0001 - 0x0000)
struct AIController_IsBehaviourTreeRunning final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AIController_IsBehaviourTreeRunning) == 0x000001, "Wrong alignment on AIController_IsBehaviourTreeRunning");
static_assert(sizeof(AIController_IsBehaviourTreeRunning) == 0x000001, "Wrong size on AIController_IsBehaviourTreeRunning");
static_assert(offsetof(AIController_IsBehaviourTreeRunning, ReturnValue) == 0x000000, "Member 'AIController_IsBehaviourTreeRunning::ReturnValue' has a wrong offset!");

// Function AIModule.AIController.IsBehaviourTreeStopped
// 0x0001 (0x0001 - 0x0000)
struct AIController_IsBehaviourTreeStopped final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AIController_IsBehaviourTreeStopped) == 0x000001, "Wrong alignment on AIController_IsBehaviourTreeStopped");
static_assert(sizeof(AIController_IsBehaviourTreeStopped) == 0x000001, "Wrong size on AIController_IsBehaviourTreeStopped");
static_assert(offsetof(AIController_IsBehaviourTreeStopped, ReturnValue) == 0x000000, "Member 'AIController_IsBehaviourTreeStopped::ReturnValue' has a wrong offset!");
