...
static_assert(sizeof(AInternalToolFrameworkActor) == 0x000238, "Wrong size on AInternalToolFrameworkActor");
...
static_assert(sizeof(AGizmoActor) == 0x000238, "Wrong size on AGizmoActor");
...
{
public:
	struct FLinearColor                           Color;                                             // 0x0460(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         HoverSizeMultiplier;                               // 0x0470(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PixelHitDistanceThreshold;                         // 0x0474(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGizmoBaseComponent, Color) == 0x000460, "Member 'UGizmoBaseComponent::Color' has a wrong offset!");
static_assert(offsetof(UGizmoBaseComponent, HoverSizeMultiplier) == 0x000470, "Member 'UGizmoBaseComponent::HoverSizeMultiplier' has a wrong offset!");
static_assert(offsetof(UGizmoBaseComponent, PixelHitDistanceThreshold) == 0x000474, "Member 'UGizmoBaseComponent::PixelHitDistanceThreshold' has a wrong offset!");
...
{
public:
	struct FVector                                Direction;                                         // 0x0480(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Gap;                                               // 0x048C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	float                                         Thickness;                                         // 0x0494(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGizmoArrowComponent, Direction) == 0x000480, "Member 'UGizmoArrowComponent::Direction' has a wrong offset!");
static_assert(offsetof(UGizmoArrowComponent, Gap) == 0x00048C, "Member 'UGizmoArrowComponent::Gap' has a wrong offset!");
static_assert(offsetof(UGizmoArrowComponent, Length) == 0x000490, "Member 'UGizmoArrowComponent::Length' has a wrong offset!");
static_assert(offsetof(UGizmoArrowComponent, Thickness) == 0x000494, "Member 'UGizmoArrowComponent::Thickness' has a wrong offset!");
...
{
public:
	struct FVector                                Origin;                                            // 0x0480(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGizmoBoxComponent, Origin) == 0x000480, "Member 'UGizmoBoxComponent::Origin' has a wrong offset!");
...
{
public:
	struct FVector                                Normal;                                            // 0x0480(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Radius;                                            // 0x048C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	int32                                         NumSides;                                          // 0x0494(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bViewAligned;                                      // 0x0498(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOnlyAllowFrontFacingHits;                         // 0x0499(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGizmoCircleComponent, Normal) == 0x000480, "Member 'UGizmoCircleComponent::Normal' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, Radius) == 0x00048C, "Member 'UGizmoCircleComponent::Radius' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, Thickness) == 0x000490, "Member 'UGizmoCircleComponent::Thickness' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, NumSides) == 0x000494, "Member 'UGizmoCircleComponent::NumSides' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, bViewAligned) == 0x000498, "Member 'UGizmoCircleComponent::bViewAligned' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, bOnlyAllowFrontFacingHits) == 0x000499, "Member 'UGizmoCircleComponent::bOnlyAllowFrontFacingHits' has a wrong offset!");
...
public:
	struct FVector                                Normal;                                            // 0x0480(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         HandleSize;                                        // 0x048C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Thickness;                                         // 0x0490(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                Direction;                                         // 0x0494(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Length;                                            // 0x04A0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bImageScale;                                       // 0x04A4(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGizmoLineHandleComponent, Normal) == 0x000480, "Member 'UGizmoLineHandleComponent::Normal' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, HandleSize) == 0x00048C, "Member 'UGizmoLineHandleComponent::HandleSize' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, Thickness) == 0x000490, "Member 'UGizmoLineHandleComponent::Thickness' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, Direction) == 0x000494, "Member 'UGizmoLineHandleComponent::Direction' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, Length) == 0x0004A0, "Member 'UGizmoLineHandleComponent::Length' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, bImageScale) == 0x0004A4, "Member 'UGizmoLineHandleComponent::bImageScale' has a wrong offset!");
...
{
public:
	struct FVector                                DirectionX;                                        // 0x0480(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                DirectionY;                                        // 0x048C(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         OffsetX;                                           // 0x0498(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         OffsetY;                                           // 0x049C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LengthX;                                           // 0x04A0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LengthY;                                           // 0x04A4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Thickness;                                         // 0x04A8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         SegmentFlags;                                      // 0x04AC(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGizmoRectangleComponent, DirectionX) == 0x000480, "Member 'UGizmoRectangleComponent::DirectionX' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, DirectionY) == 0x00048C, "Member 'UGizmoRectangleComponent::DirectionY' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, OffsetX) == 0x000498, "Member 'UGizmoRectangleComponent::OffsetX' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, OffsetY) == 0x00049C, "Member 'UGizmoRectangleComponent::OffsetY' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, LengthX) == 0x0004A0, "Member 'UGizmoRectangleComponent::LengthX' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, LengthY) == 0x0004A4, "Member 'UGizmoRectangleComponent::LengthY' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, Thickness) == 0x0004A8, "Member 'UGizmoRectangleComponent::Thickness' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, SegmentFlags) == 0x0004AC, "Member 'UGizmoRectangleComponent::SegmentFlags' has a wrong offset!");
...
{
public:
	class UGizmoLineHandleComponent*              UpIntervalComponent;                               // 0x0238(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGizmoLineHandleComponent*              DownIntervalComponent;                             // 0x0240(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGizmoLineHandleComponent*              ForwardIntervalComponent;                          // 0x0248(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AIntervalGizmoActor) == 0x000250, "Wrong size on AIntervalGizmoActor");
static_assert(offsetof(AIntervalGizmoActor, UpIntervalComponent) == 0x000238, "Member 'AIntervalGizmoActor::UpIntervalComponent' has a wrong offset!");
static_assert(offsetof(AIntervalGizmoActor, DownIntervalComponent) == 0x000240, "Member 'AIntervalGizmoActor::DownIntervalComponent' has a wrong offset!");
static_assert(offsetof(AIntervalGizmoActor, ForwardIntervalComponent) == 0x000248, "Member 'AIntervalGizmoActor::ForwardIntervalComponent' has a wrong offset!");
...
{
public:
	class UPrimitiveComponent*                    TranslateX;                                        // 0x0238(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    TranslateY;                                        // 0x0240(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    TranslateZ;                                        // 0x0248(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    TranslateYZ;                                       // 0x0250(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    TranslateXZ;                                       // 0x0258(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    TranslateXY;                                       // 0x0260(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    RotateX;                                           // 0x0268(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    RotateY;                                           // 0x0270(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    RotateZ;                                           // 0x0278(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    UniformScale;                                      // 0x0280(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    AxisScaleX;                                        // 0x0288(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    AxisScaleY;                                        // 0x0290(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    AxisScaleZ;                                        // 0x0298(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    PlaneScaleYZ;                                      // 0x02A0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    PlaneScaleXZ;                                      // 0x02A8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    PlaneScaleXY;                                      // 0x02B0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ATransformGizmoActor) == 0x0002B8, "Wrong size on ATransformGizmoActor");
static_assert(offsetof(ATransformGizmoActor, TranslateX) == 0x000238, "Member 'ATransformGizmoActor::TranslateX' has a wrong offset!");
static_assert(offsetof(ATransformGizmoActor, TranslateY) == 0x000240, "Member 'ATransformGizmoActor::TranslateY' has a wrong offset!");
static_assert(offsetof(ATransformGizmoActor, TranslateZ) == 0x000248, "Member 'ATransformGizmoActor::TranslateZ' has a wrong offset!");
static_assert(offsetof(ATransformGizmoActor, TranslateYZ) == 0x000250, "Member 'ATransformGizmoActor::TranslateYZ' has a wrong offset!");
static_assert(offsetof(ATransformGizmoActor, TranslateXZ) == 0x000258, "Member 'ATransformGizmoActor::TranslateXZ' has a wrong offset!");
static_assert(offsetof(ATransformGizmoActor, TranslateXY) == 0x000260, "Member 'ATransformGizmoActor::TranslateXY' has a wrong offset!");
static_assert(offsetof(ATransformGizmoActor, RotateX) == 0x000268, "Member 'ATransformGizmoActor::RotateX' has a wrong offset!");
static_assert(offsetof(ATransformGizmoActor, RotateY) == 0x000270, "Member 'ATransformGizmoActor::RotateY' has a wrong offset!");
static_assert(offsetof(ATransformGizmoActor, RotateZ) == 0x000278, "Member 'ATransformGizmoActor::RotateZ' has a wrong offset!");
static_assert(offsetof(ATransformGizmoActor, UniformScale) == 0x000280, "Member 'ATransformGizmoActor::UniformScale' has a wrong offset!");
static_assert(offsetof(ATransformGizmoActor, AxisScaleX) == 0x000288, "Member 'ATransformGizmoActor::AxisScaleX' has a wrong offset!");
static_assert(offsetof(ATransformGizmoActor, AxisScaleY) == 0x000290, "Member 'ATransformGizmoActor::AxisScaleY' has a wrong offset!");
static_assert(offsetof(ATransformGizmoActor, AxisScaleZ) == 0x000298, "Member 'ATransformGizmoActor::AxisScaleZ' has a wrong offset!");
static_assert(offsetof(ATransformGizmoActor, PlaneScaleYZ) == 0x0002A0, "Member 'ATransformGizmoActor::PlaneScaleYZ' has a wrong offset!");
static_assert(offsetof(ATransformGizmoActor, PlaneScaleXZ) == 0x0002A8, "Member 'ATransformGizmoActor::PlaneScaleXZ' has a wrong offset!");
static_assert(offsetof(ATransformGizmoActor, PlaneScaleXY) == 0x0002B0, "Member 'ATransformGizmoActor::PlaneScaleXY' has a wrong offset!");
