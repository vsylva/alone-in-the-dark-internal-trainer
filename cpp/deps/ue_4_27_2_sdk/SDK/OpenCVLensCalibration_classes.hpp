...
static_assert(sizeof(UOpenCVLensCalibrator) == 0x000080, "Wrong size on UOpenCVLensCalibrator");
...
static_assert(offsetof(UOpenCVLensCalibrator, MaximumCornerCoordinates) == 0x000030, "Member 'UOpenCVLensCalibrator::MaximumCornerCoordinates' has a wrong offset!");
